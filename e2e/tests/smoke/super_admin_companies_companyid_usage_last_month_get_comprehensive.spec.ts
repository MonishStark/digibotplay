...
test.describe("GET /super-admin/companies/{companyId}/usage/last-month - Comprehensive Tests", () => {
	...
	test.describe("200 Success Responses", () => {
		test("should retrieve last month's usage successfully - 200", async ({
			request,
		}) => {
		...
		test("should return aggregated usage data", async ({ request }) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/companies/${testCompanyId}/usage/last-month`,
				{
					headers: {
		...
		test("should include total queries in response", async ({ request }) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/companies/${testCompanyId}/usage/last-month`,
				{
					headers: {
		...
		test("should include storage used in response", async ({ request }) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/companies/${testCompanyId}/usage/last-month`,
				{
					headers: {
		...
		test("should include subscription plan information", async ({
			request,
		}) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/companies/${testCompanyId}/usage/last-month`,
	...
	test.describe("400 Bad Request Responses", () => {
		test("should return 400 for invalid companyId format", async ({
			...
			const response = await request.get(
				`${API_BASE_URL}/super-admin/companies/invalid-id/usage/last-month`,
				{
					headers: {
						Authorization: `Bearer ${validAccessToken}`,
					},
	...
	test.describe("404 Not Found Responses", () => {
		test("should return 404 for non-existent company", async ({ request }) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/companies/99999999/usage/last-month`,
				{
					headers: {
						Authorization: `Bearer ${validAccessToken}`,
					},
		...
		test("should return 404 for company without usage data", async ({
			request,
		}) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/companies/12345/usage/last-month`,
				{
					headers: {
						Authorization: `Bearer ${validAccessToken}`,
					},
