...
test.describe("GET /super-admin/environment - Comprehensive Tests", () => {
	...
	test.describe("200 Success Responses", () => {
		test("should retrieve environment configuration successfully - 200", async ({
			request,
		}) => {
		...
		test("should return environment keys and values", async ({ request }) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/environment`,
				{
					headers: {
		...
		test("should be read-only endpoint", async ({ request }) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/environment`,
				{
					headers: {
	...
	test.describe("404 Not Found Responses", () => {
		test("should handle 404 for no environment settings found", async ({
			request,
		}) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/environment`,
