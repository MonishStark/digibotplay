...
test.describe('GET /settings/recording-limit Tests', () => {
    ...
    test('GET /settings/recording-limit - 200 Success', async ({ request }) => {
    ...
    test('GET /settings/recording-limit - 401 Unauthorized', async ({ request }) => {
        const response = await request.get(`${API_URL}/settings/recording-limit`);
