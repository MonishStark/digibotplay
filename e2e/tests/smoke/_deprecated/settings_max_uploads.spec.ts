...
test.describe('GET /settings/max-uploads Tests', () => {
    ...
    test('GET /settings/max-uploads - 200 Success', async ({ request }) => {
    ...
    test('GET /settings/max-uploads - 401 Unauthorized', async ({ request }) => {
        const response = await request.get(`${API_URL}/settings/max-uploads`);
