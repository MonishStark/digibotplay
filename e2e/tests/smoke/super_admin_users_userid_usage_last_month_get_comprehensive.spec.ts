...
test.describe("GET /super-admin/users/{userId}/usage/last-month - Comprehensive Tests", () => {
	...
	test.describe("200 Success Responses", () => {
		test("should retrieve user's last month usage successfully - 200", async ({
			request,
		}) => {
		...
		test("should return individual user usage data", async ({ request }) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/users/${testUserId}/usage/last-month`,
				{
					headers: {
		...
		test("should include queries count in response", async ({ request }) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/users/${testUserId}/usage/last-month`,
				{
					headers: {
		...
		test("should include storage information", async ({ request }) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/users/${testUserId}/usage/last-month`,
				{
					headers: {
	...
	test.describe("400 Bad Request Responses", () => {
		test("should return 400 for invalid userId format", async ({ request }) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/users/invalid-id/usage/last-month`,
				{
					headers: {
						Authorization: `Bearer ${validAccessToken}`,
					},
	...
	test.describe("404 Not Found Responses", () => {
		test("should return 404 for non-existent user", async ({ request }) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/users/99999999/usage/last-month`,
				{
					headers: {
						Authorization: `Bearer ${validAccessToken}`,
					},
		...
		test("should return 404 for user without usage data", async ({
			request,
		}) => {
			const response = await request.get(
				`${API_BASE_URL}/super-admin/users/12345/usage/last-month`,
				{
					headers: {
						Authorization: `Bearer ${validAccessToken}`,
					},
